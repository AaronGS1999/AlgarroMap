    ...
    const legendContent = `
        <div id="legend-popup-content" style="padding: 20px; background-color: white; border: 1px solid #ccc; border-radius: 5px; font-size: 16px; max-width: 450px; max-height: 650px; overflow-y: auto; text-align: center;">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 15px; justify-content: flex-start;">
                <img src="Iconos/injerto.png" alt="Injertada" style="width: 50px; height: 50px; margin-right: 15px;">
                <span>Injertadas: ${tiposArboles.injertada}</span>
            </div>
            <div style="display: flex; align-items: center; margin-bottom: 15px; justify-content: flex-start;">
                <img src="Iconos/hermafrodita.png" alt="Hermafrodita" style="width: 50px; height: 50px; margin-right: 15px;">
                <span>Hermafroditas: ${tiposArboles.hermafrodita}</span>
            </div>
            <div style="display: flex; align-items: center; margin-bottom: 15px; justify-content: flex-start;">
                <img src="Iconos/hembra.png" alt="Hembra" style="width: 50px; height: 50px; margin-right: 15px;">
                <span>Hembras: ${tiposArboles.hembra}</span>
            </div>
            <div style="display: flex; align-items: center; margin-bottom: 15px; justify-content: flex-start;">
                <img src="Iconos/macho.png" alt="Macho" style="width: 50px; height: 50px; margin-right: 15px;">
                <span>Machos: ${tiposArboles.macho}</span>
            </div>
            <div style="display: flex; align-items: center; justify-content: flex-start;">
                <img src="Iconos/Algarrobo_gris.png" alt="Otros" style="width: 50px; height: 50px; margin-right: 15px;">
                <span>Otros: ${tiposArboles.otros}</span>
            </div>
            <hr style="margin-top: 20px; margin-bottom: 15px;">
            <div style="display: flex; align-items: center; justify-content: flex-start;">
                <img src="Iconos/Algarrobo_color.png" alt="Total de árboles" style="width: 50px; height: 50px; margin-right: 15px;">
